    ...
    static styles = css`
        :host {
            > altshift-footer {
                ...
                /* The marks sit under the last two links, GitHub under About and LinkedIn under
                   Contact; left to auto-placement they would start under Services. */
                > .github-box {
                    grid-column: 2;
                }
    ...
    render() {
        return html`
            <altshift-footer>
                ...
                <altshift-box unbordered contracted textBox selectable class="second-row github-box">
                ...
                <altshift-box unbordered contracted textBox selectable class="second-row linkedin-box">
